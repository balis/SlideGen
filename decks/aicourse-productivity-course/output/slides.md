...
- Summarising text is a high-reliability task for current chat tools — LLM summaries consistently match or beat human-written ones <!-- claim:llm_productivity:001 -->
<!-- ADVISORY [claim:llm_productivity:001] (MINOR): "match or beat" understates source which says "consistently outperform." Suggested: LLM summaries consistently outperform human-written ones -->
- AI-generated summaries show equal or fewer hallucinations than human-written reference summaries <!-- claim:llm_productivity:001 -->

<!-- Speaker: Open with "What have you already used a chat tool for?" — collect a few answers, then anchor: summarising is the sweet spot the research actually confirms. Drafting, restructuring, and tone-shifting are also widely used but backed more by practitioner experience than this study. -->
...
- Arithmetic inside word problems degrades: logical error rates jump up to 14 percentage points as numbers get harder <!-- claim:llm_productivity:002 -->
- Chat tools fabricate citations at high rates — even the best models invent 18-29% of references <!-- claim:llm_productivity:003 -->
<!-- ADVISORY [claim:llm_productivity:003] (MINOR): Source says 18%-28.6%, bullet rounds to 29%. Suggested: GPT-4 still invents 18-28.6% of references -->
...
<!-- ADVISORY [claim:llm_productivity:006] (MINOR): Source discusses general prompt structure, not email-specific. Suggested: Adding context to your prompt gives the model what it needs to produce a more targeted draft -->
...
<!-- ADVISORY [claim:llm_productivity:016] (MINOR): Source says "more than 30%" and applies to structured prompting generally. Suggested: Structured prompting improves task performance by 6% to over 30% across domains -->
...
- LLMs are unreliable at date and calendar arithmetic: accuracy on temporal primitives ranges from near-zero to perfect depending on the model and prompting conditions <!-- claim:llm_productivity:023 -->
- Tokenizers fragment calendar dates into meaningless pieces (e.g. '20250312' becomes '202', '503', '12') — excessive fragmentation correlates with accuracy drops of up to 10 percentage points on uncommon dates such as historical and future dates <!-- claim:llm_productivity:024 -->
- On event temporal reasoning, even GPT-4 trails humans by over 25% — though it scores perfectly on simple date arithmetic <!-- claim:llm_productivity:025 -->
...
<!-- ADVISORY [claim:llm_productivity:027] (MINOR): Source says "meeting transcription" not "meeting notes." Suggested: a meeting transcription -->
